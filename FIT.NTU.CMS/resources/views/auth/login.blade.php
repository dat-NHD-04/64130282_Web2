    ...
    <x-authentication-card>
        ...
        <div class="relative mt-4">
            ...
            <div class="relative flex justify-center text-sm font-medium leading-6">
                <span class="bg-white px-6 dark:bg-gray-800 dark:text-gray-100 text-gray-900">Hoặc tiếp tục với</span>
            </div>
        </div>
        <div class="flex">
            <a class="w-1/2" href="{{ route('auth.redirect', 'google') }}">
                <x-mary-button label="Google" icon="fab.google" class="btn-ghost w-full" />
            </a>
            <a class="w-1/2">
