                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="pageName" id="pageName" class="form-control"
                                        placeholder="Page Name" value="{{ $page->pageName }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="keyword" id="keyword" class="form-control"
                                        placeholder="Keyword" value="{{ $page->keyword }}">
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="content" id="content" cols="30" rows="10" class="summernote" placeholder="Page Content">{{ $page->content }}</textarea>
                                    <p></p>
                                </div>
                            </div>
                            <div class="col-md-12">
                            ...
                            <div class="pt-3">
                                ...
                                <a href="{{ route('pages.index') }}" class="btn btn-outline-dark ml-3"><i
